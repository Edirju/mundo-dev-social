export const PROJECTS = [
  ...
  // },
  // {
  //   slug: "19-markdown-editor",
  //   title: "Editor Markdown",
  //   description: "Editor Markdown con vista previa en tiempo real.",
  //   learnings: ["Clases", "CSS", "JS", "Eventos", "DOM", "Markdown"],
  //   theme: {
  //     isDark: false,
  //   },
  //   youtube: "https://www.youtube.com/watch?v=HvoiF1MCPGs",
  // },
  // {
  //   slug: "20-font-clamp-app",
  //   title: "CSS Font clamp Magic",
  //   description: "Genera tipografías responsivas perfectas con la funcion clamp().",
  //   learnings: ["JS", "CSS", "Clases", "Events", "Functions", "Responsive", "clamp()"],
  //   theme: {
  //     isDark: false,
  //   },
  //   youtube: "https://www.youtube.com/watch?v=HvoiF1MCPGs",
  ...
  // {
  //   slug: "21-tetris-one",
  //   title: "Tetris Version One",
  //   description: "Famoso juego del Tetris",
  //   learnings: ["POO", "JS", "Clases", "Teclado"],
  //   theme: {
  //     isDark: false,
  //   },
  //   youtube: "https://www.youtube.com/watch?v=HvoiF1MCPGs",
